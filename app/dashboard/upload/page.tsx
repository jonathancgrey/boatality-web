        ...
        <div className="space-y-2">
          ...
          <select
            ...
            onChange={(e) => {
              ...
              const chan = channels.find((c: any) => c.id === e.target.value);
              setPrimaryCategory(chan?.category || "");
            }}
          >
          ...
          >
            ...
            <p className="mt-2 text-xs text-slate-300/90">
              {fileName ? (
                <>
                  Selected:{" "}
                  <span className="font-semibold text-sky-200">{fileName}</span>
                </>
              ) : (
